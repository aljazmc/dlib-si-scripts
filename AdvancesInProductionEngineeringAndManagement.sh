...
dirname="Advances in Production Engineering and Management"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dAdvances%2bin%2bproduction%2bengineering%2band%2bmanagement%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"
