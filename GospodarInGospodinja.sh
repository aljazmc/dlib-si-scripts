...
dirname="Gospodar in Gospodinja"
url="https://www.dlib.si/results/?=&query=%27rele%253dDomoljub%2b(Ljubljana)%27&pageSize=100&sortDir=ASC&sort=date&page="
...
wget --max-redirect=3 -w 1 "$url"{1..6}
