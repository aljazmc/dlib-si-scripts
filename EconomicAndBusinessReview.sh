...
dirname="Economic and Business Review"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dEconomic%2band%2bbusiness%2breview%27&fformattypeserial=journal&sortDir=ASC&sort=date&pageSize=100"
