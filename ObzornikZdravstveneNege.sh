...
dirname="Obzornik Zdravstvene Nege"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dObzornik%2bzdravstvene%2bnege%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"
