...
dirname="Natura Sloveniae"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dNatura%2bSloveniae%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"
