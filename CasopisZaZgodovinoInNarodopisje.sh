...
dirname="Casopis za Zgodovino in Narodopisje"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253d%25c4%258casopis%2bza%2bzgodovino%2bin%2bnarodopisje%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date&page="
