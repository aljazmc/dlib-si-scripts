...
dirname="Acta Ecclesiastica Sloveniae"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dActa%2becclesiastica%2bSloveniae%27&fformattypeserial=journal&sortDir=ASC&sort=date&pageSize=100"
