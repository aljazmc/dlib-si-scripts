...
dirname="Folia Biologica et Geologica"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dFolia%2bbiologica%2bet%2bgeologica%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"
