...
dirname="Blejske Delavnice iz Fizike"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dBlejske%2bdelavnice%2biz%2bfizike%27&fformattypeserial=journal&sortDir=ASC&sort=date&pageSize=100"
