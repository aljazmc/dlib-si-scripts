...
dirname="Druzboslovne Razprave"
url="https://www.dlib.si/results/?=&query=%27rele%253dDru%25c5%25beboslovne%2brazprave%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"
