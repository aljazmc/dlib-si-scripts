...
url="https://www.dlib.si/results/?query=%27rele%253dVarstvo%2bnarave%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date&frelation=Partnerstvo+za+varstvo+narave"
