...
dirname="Gozdarski Vestnik"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dGozdarski%2bvestnik%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date&page="
...
wget --load-cookies ../cookies.txt -w 7 "$url"{1..4}
