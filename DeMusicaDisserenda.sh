...
dirname="De Musica Disserenda"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dDe%2bmusica%2bdisserenda%27&fformattypeserial=journal&sortDir=ASC&sort=date&pageSize=100"
