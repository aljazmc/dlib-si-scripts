...
dirname="Glej Netopir"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dGlej%252c%2bnetopir!%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"
