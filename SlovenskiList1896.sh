...
dirname="Slovenski List 1896"
url="https://www.dlib.si/results/?=&query=%27rele%253dSlovenski%2blist%2b(1896)%27&fformattypeserial=journal&sortDir=ASC&sort=date&pageSize=100&page="
...
wget --max-redirect=3 -w 1 "$url"{1..5}
