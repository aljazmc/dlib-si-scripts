...
dirname="Akademija MM"
url="https://www.dlib.si/results/?=&query=%27rele%253dAkademija%2bMM%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"

if [ ! -f "cookies.txt" ]; then
  echo "Please extract the 'cookies.txt' from www.dlib.si with the appropriate plugin for your web browser. Save 'cookies.txt' in the same directory as AkademijaMM.sh"
  exit
fi
