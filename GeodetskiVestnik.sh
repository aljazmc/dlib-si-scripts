...
dirname="Geodetski Vestnik"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dGeodetski%2bvestnik%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date&page="
