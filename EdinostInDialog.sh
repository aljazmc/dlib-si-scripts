...
dirname="Edinost in Dialog"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dEdinost%2bin%2bdialog%27&pageSize=100&fformattypeserial=journal&sortDir=ASC&sort=date"
