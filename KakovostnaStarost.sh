...
dirname="Kakovostna Starost"
scriptname=$(echo "$dirname" | tr -d ' ')
url="https://www.dlib.si/results/?=&query=%27rele%253dKakovostna%2bstarost%27&fformattypeserial=journal&sortDir=ASC&sort=date&pageSize=100"
